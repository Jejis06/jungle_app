...
const SET = (props) => {
    ...
    const ifButtonPlusGoalLimit = () => {return (goal == 3500) ? {backgroundColor: colors.Thirdary} : {backgroundColor: colors.lightGray};}
    ...
    const modifyGoal = (amm) =>{
        setGoal(clamp(goal + amm, 1000,3500));        
        props.set_goal(clamp(goal + amm, 1000,3500));
    }
